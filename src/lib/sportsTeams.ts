...
export const SPORTS_TEAMS: SportsTeam[] = [
  ...
  // PREMIER LEAGUE
  { id: 'football:ARS', sport: 'football', abbr: 'ARS', name: 'Arsenal',              color: '#EF0107', league: 'premier-league', logoUrl: fdo(57) },
  { id: 'football:CHE', sport: 'football', abbr: 'CHE', name: 'Chelsea',              color: '#034694', league: 'premier-league', logoUrl: fdo(61) },
  { id: 'football:LIV', sport: 'football', abbr: 'LIV', name: 'Liverpool',            color: '#C8102E', league: 'premier-league', logoUrl: fdo(64) },
  { id: 'football:MCI', sport: 'football', abbr: 'MCI', name: 'Manchester City',      color: '#6CABDD', league: 'premier-league', logoUrl: fdo(65) },
  { id: 'football:MUN', sport: 'football', abbr: 'MUN', name: 'Manchester United',    color: '#DA291C', league: 'premier-league', logoUrl: fdo(66) },
  { id: 'football:TOT', sport: 'football', abbr: 'TOT', name: 'Tottenham Hotspur',    color: '#132257', league: 'premier-league', logoUrl: fdo(73) },
  { id: 'football:NEW', sport: 'football', abbr: 'NEW', name: 'Newcastle United',     color: '#241F20', league: 'premier-league', logoUrl: fdo(67) },
  { id: 'football:AVL', sport: 'football', abbr: 'AVL', name: 'Aston Villa',          color: '#670E36', league: 'premier-league', logoUrl: fdo(58) },
  { id: 'football:WHU', sport: 'football', abbr: 'WHU', name: 'West Ham United',      color: '#7A263A', league: 'premier-league', logoUrl: fdo(563) },
  { id: 'football:BHA', sport: 'football', abbr: 'BHA', name: 'Brighton',             color: '#0057B8', league: 'premier-league', logoUrl: fdo(397) },
  { id: 'football:BRE', sport: 'football', abbr: 'BRE', name: 'Brentford',            color: '#E30613', league: 'premier-league', logoUrl: fdo(402) },
  { id: 'football:FUL', sport: 'football', abbr: 'FUL', name: 'Fulham',               color: '#CC0000', league: 'premier-league', logoUrl: fdo(63) },
  { id: 'football:CRY', sport: 'football', abbr: 'CRY', name: 'Crystal Palace',       color: '#1B458F', league: 'premier-league', logoUrl: fdo(354) },
  { id: 'football:WOL', sport: 'football', abbr: 'WOL', name: 'Wolverhampton',        color: '#FDB913', league: 'premier-league', logoUrl: fdo(76) },
  { id: 'football:EVE', sport: 'football', abbr: 'EVE', name: 'Everton',              color: '#003399', league: 'premier-league', logoUrl: fdo(62) },
  { id: 'football:LEI', sport: 'football', abbr: 'LEI', name: 'Leicester City',       color: '#003090', league: 'premier-league', logoUrl: fdo(338) },
  { id: 'football:IPS', sport: 'football', abbr: 'IPS', name: 'Ipswich Town',         color: '#0044A9', league: 'premier-league', logoUrl: fdo(349) },
  { id: 'football:SOU', sport: 'football', abbr: 'SOU', name: 'Southampton',          color: '#D71920', league: 'premier-league', logoUrl: fdo(340) },
  { id: 'football:BOU', sport: 'football', abbr: 'BOU', name: 'Bournemouth',          color: '#DA291C', league: 'premier-league', logoUrl: fdo(1044) },
  { id: 'football:NFO', sport: 'football', abbr: 'NFO', name: 'Nottingham Forest',    color: '#DD0000', league: 'premier-league', logoUrl: fdo(351) },

  // BUNDESLIGA
  { id: 'football:FCB', sport: 'football', abbr: 'FCB', name: 'Bayern Munich',        color: '#DC052D', league: 'bundesliga', logoUrl: fdo(5) },
  { id: 'football:BVB', sport: 'football', abbr: 'BVB', name: 'Borussia Dortmund',   color: '#FDE100', league: 'bundesliga', logoUrl: fdo(4) },
  { id: 'football:B04', sport: 'football', abbr: 'B04', name: 'Bayer Leverkusen',     color: '#E32221', league: 'bundesliga', logoUrl: fdo(3) },
  { id: 'football:RBL', sport: 'football', abbr: 'RBL', name: 'RB Leipzig',           color: '#DD0741', league: 'bundesliga', logoUrl: fdo(721) },
  { id: 'football:SGE', sport: 'football', abbr: 'SGE', name: 'Eintracht Frankfurt',  color: '#000000', league: 'bundesliga', logoUrl: fdo(19) },
  { id: 'football:VFB', sport: 'football', abbr: 'VFB', name: 'VfB Stuttgart',        color: '#E32219', league: 'bundesliga', logoUrl: fdo(10) },
  { id: 'football:WOB', sport: 'football', abbr: 'WOB', name: 'Wolfsburg',            color: '#65B32E', league: 'bundesliga', logoUrl: fdo(11) },
  { id: 'football:HOF', sport: 'football', abbr: 'HOF', name: 'Hoffenheim',           color: '#1C63B7', league: 'bundesliga', logoUrl: fdo(720) },
  { id: 'football:BMG', sport: 'football', abbr: 'BMG', name: "Borussia M'gladbach",  color: '#000000', league: 'bundesliga', logoUrl: fdo(18) },
  { id: 'football:AUG', sport: 'football', abbr: 'AUG', name: 'Augsburg',             color: '#BA3733', league: 'bundesliga', logoUrl: fdo(68) },
  { id: 'football:SVW', sport: 'football', abbr: 'SVW', name: 'Werder Bremen',        color: '#1D9053', league: 'bundesliga', logoUrl: fdo(12) },
  ...
  { id: 'football:ACM', sport: 'football', abbr: 'ACM', name: 'AC Milan',             color: '#FB090B', league: 'serie-a', logoUrl: fdo(98) },
  { id: 'football:JUV', sport: 'football', abbr: 'JUV', name: 'Juventus',             color: '#000000', league: 'serie-a', logoUrl: fdo(109) },
  { id: 'football:NAP', sport: 'football', abbr: 'NAP', name: 'Napoli',               color: '#12A0C3', league: 'serie-a', logoUrl: fdo(113) },
  { id: 'football:ROM', sport: 'football', abbr: 'ROM', name: 'AS Roma',              color: '#8E1F2F', league: 'serie-a', logoUrl: fdo(100) },
  { id: 'football:LAZ', sport: 'football', abbr: 'LAZ', name: 'Lazio',                color: '#87D8F7', league: 'serie-a', logoUrl: fdo(110) },
  { id: 'football:ATA', sport: 'football', abbr: 'ATA', name: 'Atalanta',             color: '#1E3870', league: 'serie-a', logoUrl: fdo(102) },
  { id: 'football:FIO', sport: 'football', abbr: 'FIO', name: 'Fiorentina',           color: '#4E297B', league: 'serie-a', logoUrl: fdo(99) },
  { id: 'football:BOL', sport: 'football', abbr: 'BOL', name: 'Bologna',              color: '#D8172A', league: 'serie-a', logoUrl: fdo(103) },
  { id: 'football:TOR', sport: 'football', abbr: 'TOR', name: 'Torino',               color: '#8B1A2C', league: 'serie-a', logoUrl: fdo(586) },
  { id: 'football:UDI', sport: 'football', abbr: 'UDI', name: 'Udinese',              color: '#000000', league: 'serie-a', logoUrl: fdo(115) },
  { id: 'football:GEN', sport: 'football', abbr: 'GEN', name: 'Genoa',                color: '#C8102E', league: 'serie-a', logoUrl: fdo(107) },
  { id: 'football:MON', sport: 'football', abbr: 'MON', name: 'Monza',                color: '#EB1923', league: 'serie-a', logoUrl: fdo(5911) },
  { id: 'football:LEC', sport: 'football', abbr: 'LEC', name: 'Lecce',                color: '#F0A500', league: 'serie-a', logoUrl: fdo(5890) },
  { id: 'football:CAG', sport: 'football', abbr: 'CAG', name: 'Cagliari',             color: '#004B9E', league: 'serie-a', logoUrl: fdo(488) },
  { id: 'football:EMP', sport: 'football', abbr: 'EMP', name: 'Empoli',               color: '#0066B3', league: 'serie-a', logoUrl: fdo(445) },
  ...
  { id: 'football:BAR', sport: 'football', abbr: 'BAR', name: 'FC Barcelona',         color: '#A50044', league: 'laliga', logoUrl: fdo(81) },
  { id: 'football:ATM', sport: 'football', abbr: 'ATM', name: 'Atlético Madrid',      color: '#CB3524', league: 'laliga', logoUrl: fdo(78) },
  { id: 'football:ATH', sport: 'football', abbr: 'ATH', name: 'Athletic Bilbao',      color: '#EE2523', league: 'laliga', logoUrl: fdo(77) },
  { id: 'football:RSO', sport: 'football', abbr: 'RSO', name: 'Real Sociedad',        color: '#0467AF', league: 'laliga', logoUrl: fdo(92) },
  { id: 'football:BET', sport: 'football', abbr: 'BET', name: 'Real Betis',           color: '#00A650', league: 'laliga', logoUrl: fdo(90) },
  { id: 'football:VIL', sport: 'football', abbr: 'VIL', name: 'Villarreal',           color: '#F5D800', league: 'laliga', logoUrl: fdo(94) },
  { id: 'football:VAL', sport: 'football', abbr: 'VAL', name: 'Valencia',             color: '#FF7900', league: 'laliga', logoUrl: fdo(95) },
  { id: 'football:SEV', sport: 'football', abbr: 'SEV', name: 'Sevilla',              color: '#CF0C2E', league: 'laliga', logoUrl: fdo(559) },
  ...
  { id: 'football:ALA', sport: 'football', abbr: 'ALA', name: 'Alavés',              color: '#1A59A3', league: 'laliga', logoUrl: fdo(263) },
  { id: 'football:GIR', sport: 'football', abbr: 'GIR', name: 'Girona',              color: '#CD1315', league: 'laliga', logoUrl: fdo(298) },
  { id: 'football:LEG', sport: 'football', abbr: 'LEG', name: 'Leganés',             color: '#003DA6', league: 'laliga', logoUrl: fdo(745) },
  { id: 'football:VLL', sport: 'football', abbr: 'VLL', name: 'Real Valladolid',      color: '#6B2382', league: 'laliga', logoUrl: fdo(250) },

  // LIGUE 1
  { id: 'football:PSG', sport: 'football', abbr: 'PSG', name: 'Paris Saint-Germain', color: '#004170', league: 'ligue-1', logoUrl: fdo(524) },
  { id: 'football:ASM', sport: 'football', abbr: 'ASM', name: 'Monaco',              color: '#E3172D', league: 'ligue-1', logoUrl: fdo(548) },
  { id: 'football:OLY', sport: 'football', abbr: 'OLY', name: 'Olympique Lyon',      color: '#002B6E', league: 'ligue-1', logoUrl: fdo(523) },
  { id: 'football:OM',  sport: 'football', abbr: 'OM',  name: 'Olympique Marseille', color: '#2FAEE0', league: 'ligue-1', logoUrl: fdo(516) },
  { id: 'football:RCL', sport: 'football', abbr: 'RCL', name: 'RC Lens',             color: '#E4B118', league: 'ligue-1', logoUrl: fdo(546) },
  { id: 'football:LOS', sport: 'football', abbr: 'LOS', name: 'Lille',               color: '#CB1117', league: 'ligue-1', logoUrl: fdo(521) },
